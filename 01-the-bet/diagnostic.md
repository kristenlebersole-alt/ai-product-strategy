...
**Product:Contract Intelligence**
*A product that allows contracts terms and rules to be uploaded and stored in a flexible rules (contract term engine). Contracts use an AI PDF / document leader to extract or API connect to input from internal rules engine. Pairs with our data of what actually happens (what air travel was purchased and flown that the contract pairs against. AI models used to help compare and report on the performance of the contract, but also provide scenarios and options to Travel Agencies on areas to focus improvement and prepartion for next contract negotiations to get more favorable commission terms"
**Your Role: Director Product Management - Travel Agency Products**
...
**Named attacker (from partner challenge): Sabre, Amadeus, Any one potentially getting into Airline space to displace offers/orders**
 ...
 **Score rationale: Majority of the underlying infrastructure that will help power and align this solution is proprietary, but if a large organization really wanted to push it, the size would help them compete, but still large barriers to entry as of today. Addtionally, Core customers could decide to develop and complete themselves while just purchasing the data from us, but the scale we have, the additional IP we place on the data and the ability to allow Travel Agency, Corporate Travel Programs and Airlines to see the same information would help**

**Named attacker (from partner challenge): Our own Customers or Sabre or Spotnanna **
...
* Our own customers could recreate this on their own contracts and just buy the data from us, particularly the larger organiations, pricing curve will help diminish this *
